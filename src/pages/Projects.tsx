...
export default function Projects() {
  ...
  const variants = [<SkeletonFour />, <SkeletonFive/>, <SkeletonSix />, <SkeletonOne />, <SkeletonTwo />, <SkeletonOne />];
  const pickSkeleton = (i: number) => variants[i % variants.length];

  const layoutPattern = ["2", "1", "1", "2", "2", "1", "1"]; // your pattern
...
const SkeletonOne = () => {
  ...
  return (
    ...
    >
      {/* First Row: Text on the right of the icon */}
      <motion.div
        variants={variants}
      ...
      {/* Second Row: Text on the left of the icon (Right Aligned) */}
      <motion.div
        variants={variantsSecond}
        className="flex flex-row rounded-full border border-neutral-100 dark:border-white/[0.2] p-2 items-center space-x-2 w-3/4 ml-auto bg-white dark:bg-black"
      >
        <p className="text-[10px] text-neutral-500 font-medium flex-1 text-right">
          Optimizing Code.
        </p>
        <div className="h-6 w-6 rounded-full bg-gradient-to-r from-pink-500 to-violet-500 shrink-0" />
      </motion.div>

      {/* Third Row: Text on the right of the icon */}
      <motion.div
        variants={variants}
        className="flex flex-row rounded-full border border-neutral-100 dark:border-white/[0.2] p-2 items-center space-x-2 bg-white dark:bg-black"
      >
...
const SkeletonTwo = () => {
  ...
  // Define the "works" or labels for each bar
  const labels = ["Immigrants", "Migration", "Refugee", "Deport", "Racist", "Policies"];
    ...
    >
      {labels.map((label, i) => (
        <motion.div
          ...
          className="flex flex-row rounded-full border border-neutral-100 dark:border-white/[0.2] px-3 items-center bg-neutral-100 dark:bg-black w-full h-6 overflow-hidden"
        >
          {/* Adding the text inside the animated bar */}
    ...
    >
      ...
      >
        ...
        <p className="text-xs text-neutral-500">
          I am a 37 yo SDE and want to lose 5 lbs, Help me I am so fat!
        </p>
      </motion.div>
      <motion.div
        variants={variantsSecond}
      ...
      >
        <p className="text-xs text-neutral-500">Stop eating CHIPS.</p>
        <div className="h-6 w-6 rounded-full bg-gradient-to-r from-pink-500 to-violet-500 shrink-0" />
      </motion.div>
    </motion.div>
  );
...
const SkeletonSix = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div variants={first} className="h-full relative z-20 w-full rounded-2xl bg-white p-4 dark:bg-black dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center">
        <img
          src="/images/bear-logo.png"
          alt="avatar"
          height="100"

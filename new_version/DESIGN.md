# Cho-Han Hsiung — Style Reference
> Printed monograph on vellum

**Theme:** light

This is a research and engineering monograph rendered like a printed folio on warm paper. A single warm-gray canvas (#e5e7eb) holds everything, with technical content, research prose, and diagrams floating on it without visible card containers or heavy dividers. The type system is the design: a humanist sans (Degular) handles UI, data tables, and navigation while a bookish serif (Blanco) carries all editorial weight — case study headlines, research abstracts, and section titles. Color is almost entirely absent; the only chromatic event is the near-black fill of the sole action button against the light field. Layout is a fixed left rail of nav links and a generous reading-width column of text, with technical diagrams and photography overlapping the text column as collaged inserts. Everything else — borders, hairlines, separators — is hairline and quiet.
...
Fixed left column containing the wordmark 'Cho-Han Hsiung' at top and a vertical stack of text links (Engineering, Research, Architecture, Journal, About) at the bottom. Links are 16px Degular 500 in #111827 with no decoration. A small avatar/mark sits in the top-right corner. No background, no border — it floats on the vellum field.
...
### System & Diagram Collage Block
**Role:** Hero visual element overlapping the text column

Two to three desaturated photographs or high-contrast architectural diagrams arranged in an overlapping collage, shifted left into the gutter area. Images sit directly on the vellum with a 3px corner radius. Visuals are documentary in tone: system architecture flows, data visualization crops, or workspace shots.
...
### Resumé & Project Entry
**Role:** Date-anchored experience or project block

Two-column layout: narrow left column with date range in Degular 14px #717272 (e.g. '2025–2026'), generous right column with role/project title in Blanco 400 at 22px in #2a2a28, followed by a technical stack tag list (Degular 14px) and 2-3 lines of description in Degular 16px #374151. Separated by hairline 1px #e5e7eb rules.
...
6. Create a sidebar nav: fixed left column 180px wide, wordmark 'Cho-Han Hsiung' in Degular 500 16px #111827 at top, nav links (Engineering, Research, Architecture, Journal, About) in Degular 500 16px #111827 stacked vertically at bottom with 12px gap. No background, no border.

7. Create a project entry: two-column row, left column 80px wide with date '2026' in Degular 14px #717272, right column with project title 'Macroeconomic Implications Report' in Blanco 400 22px #2a2a28 followed by description in Degular 400 18px #374151 line-height 1.5. Separate from next entry with a 1px #e5e7eb hairline and 32px vertical gap.

8. Create a hero block: two high-contrast architectural diagrams overlapping in the left third, shifted up and down by 40px to create a collage effect. Right two-thirds holds a Blanco 400 40px #2a2a28 headline 'Utraque Research' followed by 3 paragraphs of Degular 400 18px #374151 body text with 27px margin-bottom. Images have 3px border-radius, no shadow.
